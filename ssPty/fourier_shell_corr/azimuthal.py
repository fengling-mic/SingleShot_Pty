def radial_data(data,annulus_width=1,working_mask=None,x=None,y=None,rmax=None):
    ...
    #print("working_mask = ", working_mask)
    ...
    radialdata.mean = ny.zeros(nrad,complex)
    radialdata.std = ny.zeros(nrad,complex)
    radialdata.median = ny.zeros(nrad,complex)
    radialdata.numel = ny.zeros(nrad,complex)
    radialdata.max = ny.zeros(nrad,complex)
    radialdata.min = ny.zeros(nrad,complex)
    radialdata.r = radial
