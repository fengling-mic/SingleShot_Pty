...
def generate_randomized_zone_plate_xray(r_zp, bs_zp, Rmax, outer_width_zp, N, N_zp, zp_trans_complex, res_foc, wavelength, sensorPixSize,
                                        ddet, fft_plan_zp_plane, fft_plan_probe, f_cutoff=1., print_fresnel=False, force_fresnel=False):
    """
    ...
    probe_det *= initial_field_mean / probe_det.mean()
